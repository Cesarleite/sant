  ...
  const SantiagoAssistant = () => {
    ...
    const [checklist, setChecklist] = useState([
      ...
      { id: 11, item: 'Camiseta de manga longa (1 unidades)', categoria: 'Roupas', checked: false, essencial: true },
      { id: 12, item: 'Calças de caminhada (2 unidades)', categoria: 'Roupas', checked: false, essencial: true },
      { id: 13, item: 'Jaqueta corta vento e impermeavél (1 unidade)', categoria: 'Roupas', checked: false, essencial: true },
      { id: 14, item: 'Boné ou chapéu para proteção solar (1 unidade)', categoria: 'Roupas', checked: false, essencial: true },
      { id: 15, item: 'Gorro leve (1 unidade)', categoria: 'Roupas', checked: false, essencial: false },
      { id: 16, item: 'Roupa íntima (6 peças)', categoria: 'Roupas', checked: false, essencial: true },
      { id: 17, item: 'Band-aid para bolhas', categoria: 'Medicamentos', checked: false, essencial: true },
      { id: 18, item: 'Ibuprofeno', categoria: 'Medicamentos', checked: false, essencial: true },
      { id: 19, item: 'Protetor solar FPS 50+', categoria: 'Medicamentos', checked: false, essencial: true },
      { id: 20, item: 'Mochila 35-40L', categoria: 'Equipamentos', checked: false, essencial: true },
      { id: 21, item: false, essencial: true },
